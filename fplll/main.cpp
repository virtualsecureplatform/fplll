  ...
  for (int ac = 1; ac < argc; ac++)
  {
    if (strcmp(argv[ac], "-a") == 0)
    {
      ...
      if (strcmp(argv[ac], "lll") == 0)
        ...
        o.action = ACTION_BKZ;
      else if (strcmp(argv[ac], "deepbkz") == 0)
      {
        o.action = ACTION_BKZ;
      ...
      else if (strcmp(argv[ac], "potlllbkz") == 0)
      {
        o.action = ACTION_BKZ;
        o.bkz_flags |= BKZ_POT_LLL_BKZ;
      }
    ...
    else if (strcmp(argv[ac], "-bkzjump") == 0)
    {
      ++ac;
      CHECK(ac < argc, "missing value after '-bkzjump'");
      o.bkz_tour_step = atoi(argv[ac]);
    }
    ...
    else if ((strcmp(argv[ac], "-h") == 0) || (strcmp(argv[ac], "--help") == 0))
    {
      cout << "Usage: " << argv[0] << " [options] [file]\n"
           ...
           << "List of options:\n"
           << "  -a [lll|deeplll|potlll|bkz|deepbkz|potbkz|potlllbkz|hkz|svp|sdb|sld|cvp]\n"
           ...
           << "       potlllbkz = BKZ with PotLLL preprocessing and postprocessing\n"
